...
interface QuickFilterBarProps {
  ...
  /** Whether to show only "ready to work" beads (open, no unresolved blockers) */
  readyOnly?: boolean;
  /** Callback when ready-only toggle changes */
  onReadyOnlyChange?: (value: boolean) => void;
  /** Whether to show only blocked beads */
  blockedOnly?: boolean;
  /** Callback when blocked-only toggle changes */
...
export function QuickFilterBar({
  ...
  return (
    ...
    >
      ...
      {/* Ready-to-work toggle: open beads with no unresolved blockers */}
      {onReadyOnlyChange && (
        <button
          type="button"
          ...
          title="Open beads with no unresolved blockers"
        >
          Ready
        </button>
      )}
      ...
      {onBlockedOnlyChange && (
        <button
          ...
          title="Beads with unresolved blocking dependencies"
        >
          Blocked
        </button>
      )}
